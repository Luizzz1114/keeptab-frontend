...
<template>
  <header class="flex items-center justify-between p-2">
    <div
      class="flex items-center gap-1 rounded-xl border border-zinc-200 bg-white shadow-xs dark:border-zinc-700 dark:bg-zinc-900"
    >
      <div class="p-1">
        <Button
      ...
      <div class="p-1">
        <div
          class="flex items-center justify-center gap-2 px-2 text-sm text-zinc-600 dark:text-zinc-400"
        >
