          ...
          >
            <div class="flex flex-col gap-1.5">
              <div class="flex items-center gap-3">
                <div
                  class="grid size-10 shrink-0 place-items-center rounded-xl bg-emerald-100 text-lg text-emerald-500 ring ring-current/20 ring-inset dark:bg-emerald-500/10 dark:text-emerald-400"
                >
                  <i class="fi-rr-calendar-lines"></i>
                </div>
                <span class="text-base! font-extrabold text-zinc-700 dark:text-zinc-200">
                  Jornada #{{ item.id }}
                </span>
              </div>
              <div class="flex flex-col gap-0.5">
                <div class="flex items-center gap-1.5">
                  <span class="text-sm text-zinc-500 dark:text-zinc-400">
                    <strong class="font-semibold text-zinc-600 dark:text-zinc-300"
                      >Apertura:</strong
                    >
                    {{ formatTinyDate(item.apertura) }}
                  </span>
                </div>
                <div class="flex items-center gap-1.5">
                  <span class="text-sm text-zinc-500 dark:text-zinc-400">
                    <strong class="font-semibold text-zinc-600 dark:text-zinc-300">Cierre:</strong>
                    {{ item.cierre ? formatTinyDate(item.cierre) : 'En curso...' }}
                  </span>
                </div>
              </div>
            </div>
            <div
              class="flex items-center justify-between border-t border-zinc-200/60 pt-3 sm:justify-end sm:gap-6 sm:border-0 sm:pt-0 dark:border-zinc-700/60"
            >
              ...
              <i
                class="fi-rr-angle-small-right ml-2 text-xl text-zinc-400 transition-transform group-hover:translate-x-1 dark:text-zinc-500"
              ></i>
            </div>
          </div>
        </div>
