  ...
  >
    <template #container>
      <div class="relative flex flex-col items-center justify-between p-6 dark:border-zinc-700">
        ...
        >
          <p v-if="userRole === 'ADMIN'">Para comenzar a vender y atender en el mostrador, es necesario que inicies una nueva jornada de trabajo</p>
          <p v-else>El mostrador está cerrado en este momento. Por favor, solicita a un Administrador que abra la jornada para poder comenzar a vender.</p>
        </div>
      </div>
