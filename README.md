...
El sistema utiliza cookies HttpOnly para la autenticación. El frontend envía credenciales en cada petición mediante la opción `credentials: 'include'`.
